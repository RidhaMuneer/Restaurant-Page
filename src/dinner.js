...
export default function dinnerScreens(){
    ...
    dinnerLink.style.borderBottom = '1px rgb(255, 255, 255) solid';
    ...
    p1.textContent = 'Pasta de la italian';
    ...
    p4.textContent = 'Iraqi Nights Meal';
